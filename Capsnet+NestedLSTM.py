# -*- coding: utf-8 -*-
"""
Created on Tue May 15 16:41:07 2018
...
import os
os.chdir('/root/CapsnetNLSTM/CapsnetNestedLSTM')
...
model.fit(x_train, y_train,
          ...
          callbacks=[ModelCheckpoint('./capsnet+nlstm_weights3.h5', monitor='val_loss' , save_best_only=True, save_weights_only=True,verbose=1)])



model.load_weights('./capsnet+nlstm_weights3.h5')
